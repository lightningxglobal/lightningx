...
pub async fn run_migrations(pool: &PgPool) -> Result<(), sqlx::Error> {
    ...
    apply_migration(
        pool,
        "022_swap_positions",
        include_str!("../../migrations/022_swap_positions.sql"),
    )
    .await?;
    apply_migration(
        pool,
        "023_insurance_fund_signed",
        include_str!("../../migrations/023_insurance_fund_signed.sql"),
    )
    .await?;
    apply_migration(
        pool,
        "024_position_cost_basis",
        include_str!("../../migrations/024_position_cost_basis.sql"),
    )
    .await?;
    apply_migration(
        pool,
        "025_funding",
        include_str!("../../migrations/025_funding.sql"),
    )
    .await?;
    apply_migration(
        pool,
    ...
    apply_migration(
        pool,
        "028_exchange_config",
        include_str!("../../migrations/028_exchange_config.sql"),
    )
    .await?;
    apply_migration(
        pool,
        "029_engine_snapshots",
    ...
    apply_migration(
        pool,
        "031_withdrawals",
        include_str!("../../migrations/031_withdrawals.sql"),
    )
    .await?;
    Ok(())
}
